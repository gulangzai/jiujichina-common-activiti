package com.lanbao.demo.activiti.conf;
...
import com.lanbao.demo.activiti.util.PropertyFileUtil;
...
public class DemoDataInitConfig {
    ...
    public void init() {
        ...
        if (Boolean.valueOf(PropertyFileUtil.get("create.shop.users", "true"))) {
        ...
        if (Boolean.valueOf(PropertyFileUtil.get("create.shop.definitions", "true"))) {
            LOGGER.info("Initializing demo process definitions");
            initProcessDefinitions();
        }

        if (Boolean.valueOf(PropertyFileUtil.get("create.shop.models", "true"))) {
